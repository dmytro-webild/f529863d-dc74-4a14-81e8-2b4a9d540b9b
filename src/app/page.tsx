...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      avatars={[
        {
          src: "http://img.b2bpic.net/free-photo/still-life-graphic-design-day_52683-160825.jpg",
          alt: "Graphic design desk",
        },
        {
          src: "http://img.b2bpic.net/free-photo/professional-studio-setup-ai-generated-content-photography-editing_482257-125507.jpg",
          alt: "Professional studio setup",
        },
        {
          src: "http://img.b2bpic.net/free-photo/nobody-photography-studio-with-retouching-equipment-technology-media-production-empty-workplace-image-edit-using-retouch-software-computer-office-photographer_482257-28778.jpg",
          alt: "Retouching studio",
        },
        {
          src: "http://img.b2bpic.net/free-photo/side-view-computer-screen-office-workspace_23-2148821932.jpg",
      ...
      features={[
        {
          id: "1",
          title: "Logo Design",
          subtitle: "Visual identity that sticks.",
          category: "Branding",
          value: "From $299",
          buttons: [
            {
        ...
        },
        {
          id: "2",
          title: "Branding",
          subtitle: "Complete business identity.",
          category: "Design",
          value: "Custom Quote",
          buttons: [
            {
  ...
  <div id="portfolio" data-section="portfolio">
      ...
      products={[
        {
          id: "p1",
          name: "Local Cafe Branding",
          price: "Identity",
          variant: "Logo & Menu",
          imageSrc: "http://img.b2bpic.net/free-photo/white-hoodie-mockup-front_1258-248336.jpg",
        },
        {
          id: "p2",
          ...
          price: "Print",
          variant: "High Gloss",
          imageSrc: "http://img.b2bpic.net/free-vector/modern-portfolio-presentation-template_742173-32833.jpg",
        },
        {
          id: "p3",
          name: "E-commerce Social Set",
          price: "Digital",
          variant: "Instagram/FB",
        ...
        },
        {
          ...
          price: "Identity",
          variant: "Vector Files",
          imageSrc: "http://img.b2bpic.net/free-vector/connectivity-5g-technology-icons_24877-53969.jpg",
        },
        {
          id: "p5",
          ...
          imageSrc: "http://img.b2bpic.net/free-photo/tag-trademark-copyright-business-marketing-icon-concept_53876-123706.jpg",
        },
        {
          id: "p6",
          name: "Service Biz Graphics",
          price: "Branding",
          variant: "Comprehensive",
          imageSrc: "http://img.b2bpic.net/free-vector/cloud-rocket-logo-gradient-design_474888-2737.jpg",
        },
      ]}
      ...
      testimonials={[
        {
          ...
          testimonial: "Kinza transformed our menu branding and we've seen 20% more engagement on social media already!",
          rating: 5,
        ...
        },
        {
          ...
          testimonial: "Professional, fast, and incredibly creative. I couldn't be happier with our new brand identity.",
          rating: 5,
        ...
        },
        {
          ...
          testimonial: "Excellent graphic design service. Kinza really listened to my needs and delivered above expectations.",
          rating: 5,
        ...
        },
        {
          ...
          testimonial: "The best investment for my business. The flyers look absolutely premium and professional.",
          rating: 5,
        ...
        },
        {
          ...
          testimonial: "Efficient workflow and stunning results. Highly recommend for any business branding needs.",
          rating: 5,
      ...
      faqs={[
        {
          ...
          content: "Most projects are completed within 3-5 business days depending on complexity.",
        },
        {
          id: "f2",
          title: "Can you design for print?",
          content: "Yes! I specialize in both print-ready files and digital assets for web.",
        },
        {
          id: "f3",
          title: "Do you offer revisions?",
          content: "Each package includes two rounds of revisions to ensure you are 100% satisfied.",
        },
      ]}
  ...
  <div id="footer" data-section="footer">
      ...
      columns={[
        ...
        },
        {
          ...
          items: [
            {
              label: "Email: hello@kinza.design",
              href: "mailto:hello@kinza.design",
            },
            {
              label: "Phone: +1 555 012-3456",
              href: "tel:+15550123456",
            },
          ],
        },
